...
// ImagePro_20212052Doc.cpp: CImagePro20212052Doc 클래스의 구현
//
...
// CImagePro20212052Doc

IMPLEMENT_DYNCREATE(CImagePro20212052Doc, CDocument)

BEGIN_MESSAGE_MAP(CImagePro20212052Doc, CDocument)
END_MESSAGE_MAP()


// CImagePro20212052Doc 생성/소멸

CImagePro20212052Doc::CImagePro20212052Doc() noexcept
{
...
CImagePro20212052Doc::~CImagePro20212052Doc()
{
}

BOOL CImagePro20212052Doc::OnNewDocument()
{
...
// CImagePro20212052Doc serialization

void CImagePro20212052Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CImagePro20212052Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CImagePro20212052Doc::InitializeSearchContent()
{
...
void CImagePro20212052Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CImagePro20212052Doc 진단

#ifdef _DEBUG
void CImagePro20212052Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void CImagePro20212052Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// CImagePro20212052Doc 명령


int CImagePro20212052Doc::LoadImageFile(CArchive& ar)
{
	int maxValue, i;
...
int CImagePro20212052Doc::LoadSecondImageFile(CArchive& ar)
{
	// TODO: 여기에 구현 코드 추가.
	int w, h, d;
	int maxValue, i;
